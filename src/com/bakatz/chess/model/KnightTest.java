    ...
    extends GUITestCase
{
    ...
    public void testMovementOfKnight()
    {
        ...
        ArrayList<ChessLocation> moves = knight.calculatePossibleMoves( board );
        int moveRow = moves.get(0).getX();//Integer.parseInt( moves.get( 0 ).split( "," )[0] );
        int moveCol = moves.get(0).getY();//Integer.parseInt( moves.get( 0 ).split( "," )[1] );
