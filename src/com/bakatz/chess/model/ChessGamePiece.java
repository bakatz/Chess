...
import com.bakatz.chess.controller.ChessGameEngine;
...
public abstract class ChessGamePiece
{
     ...
     */
    protected ArrayList<ChessLocation> possibleMoves;
     ...
     */
    protected abstract ArrayList<ChessLocation> calculatePossibleMoves(
        ChessGameBoard board );
     ...
     */
    protected ArrayList<ChessLocation> calculateSouthMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ...
        if ( isPieceOnScreen() )
        {
            for ( int i = pieceRow + 1; i < 8 && count < numMoves; i++ )
            {
                ...
                {
                    moves.add( new ChessLocation(i , pieceColumn) );
                    count++;
     ...
     */
    protected ArrayList<ChessLocation> calculateNorthMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ArrayList<ChessLocation> moves = new ArrayList<ChessLocation>();
     ...
     * @return ArrayList<String> the moves in this direction
     */
    protected ArrayList<ChessLocation> calculateEastMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ArrayList<ChessLocation> moves = new ArrayList<ChessLocation>();
        ...
        if ( isPieceOnScreen() )
        {
            for ( int i = pieceColumn + 1; i < 8 && count < numMoves; i++ )
            {
                ...
                {
                    moves.add( new ChessLocation(pieceRow, i ));
                    count++;
     ...
     * @return ArrayList<String> the moves in this direction
     */
    protected ArrayList<ChessLocation> calculateWestMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ArrayList<ChessLocation> moves = new ArrayList<ChessLocation>();
     ...
     * @return ArrayList<String> the moves in this direction
     */
    protected ArrayList<ChessLocation> calculateNorthWestMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ArrayList<ChessLocation> moves = new ArrayList<ChessLocation>();
        ...
        if ( isPieceOnScreen() )
        {
            for ( int i = 1; i < 8 && count < numMoves; i++ )
            {
                ...
                {
                    moves.add( new ChessLocation( pieceRow - i , pieceColumn - i ) );
                    count++;
                }
     ...
     * @return ArrayList<String> the moves in this direction
     */
    protected ArrayList<ChessLocation> calculateNorthEastMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ArrayList<ChessLocation> moves = new ArrayList<ChessLocation>();
     ...
     * @return ArrayList<String> the moves in this direction
     */
    protected ArrayList<ChessLocation> calculateSouthWestMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ArrayList<ChessLocation> moves = new ArrayList<ChessLocation>();
     ...
     * @return ArrayList<String> the moves in this direction
     */
    protected ArrayList<ChessLocation> calculateSouthEastMoves(
        ChessGameBoard board,
        int numMoves )
    {
        ArrayList<ChessLocation> moves = new ArrayList<ChessLocation>();
    ...
    public void showLegalMoves( ChessGameBoard board )
    {
        ...
        if ( isPieceOnScreen() )
        {
            for ( ChessLocation loc : possibleMoves )
            {
                int row = loc.getX();//Integer.parseInt( currCoords[0] );
                int col = loc.getY();//Integer.parseInt( currCoords[1] );
